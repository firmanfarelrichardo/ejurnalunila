...
// Tingkatkan batas waktu eksekusi untuk proses yang panjang
set_time_limit(0); 
...
$jurnal_list_from_db = [];
// Perbaikan: Menggunakan kolom 'judul_jurnal' dan 'link_oai' sesuai database
...
foreach ($jurnal_list_from_db as $jurnal) {
    $jurnal_id = $jurnal['id'];
    $nama_jurnal = $jurnal['judul_jurnal'];
    ...
    do {
        ...
        // Proses semua record di halaman ini
